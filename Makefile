...
# Display the warning only instead of error
KBUILD_CFLAGS   += $(call cc-option,-Wno-error=implicit-int,-Wno-error=strict-prototypes,-Wno-error=date-time,-Wno-error=incompatible-pointer-types,-Wno-error=designated-init)
endif
